    ...
    <div class="app-container">
      ...
      <div class="p-mt-2">
        ...
        >
          ...
          <Column header="Selling Price" v-if="searchFilters.type == 'Sales' || searchFilters.type == 'Refund' || searchFilters.type == 'Transfer'">
             <template #body="slotProps">
              {{ formatAmount(slotProps.data.sellingPrice) }}
            </template>
          </Column>
          <Column header="Purchase Price" v-if="searchFilters.type == 'Purchase' || searchFilters.type == 'Purchase Return'">
             <template #body="slotProps">
              {{ formatAmount(slotProps.data.purchasePrice) }}
            </template>
          </Column>
          <Column header="Disc" v-if="searchFilters.type == 'Sales' || searchFilters.type == 'Refund' || searchFilters.type == 'Transfer'">
             <template #body="slotProps">
              {{ formatAmount(slotProps.data.itemDisc) }} %
            </template>
          </Column>
          <Column header="Purchase Disc" v-if="searchFilters.type == 'Purchase' || searchFilters.type == 'Purchase Return'">
             <template #body="slotProps">
          ...
          <Column  :header="taxNames[0].taxName + '(Amount)'" v-if="taxNames[0].show == 'true'">
             <template #body="slotProps">
          ...
          <Column  :header="taxNames[1].taxName + '(%)'" v-if="taxNames[1].show == 'true'">
           ...
           <Column  :header="taxNames[1].taxName + '(Amount)'" v-if="taxNames[1].show == 'true'">
             <template #body="slotProps">
          ...
          <Column  :header="taxNames[2].taxName + '(%)'" v-if="taxNames[2].show == 'true'">
           ...
           <Column  :header="taxNames[2].taxName + '(Amount)'" v-if="taxNames[2].show == 'true'">
             <template #body="slotProps">
