  ...
  <section class="p-m-2">
      <div class="p-grid">
        <div class="p-col-12 p-mt-2">
          <div class="p-d-flex p-jc-between custom_dashboard_header_m17">
              <div class="store-name p-mt-1 mx-1">
      ...
      <div class="cards_container_m17">
        <div  iv class="p-sm-12 custom_card_m17 p-lg-2 p-md-2" style="padding-right:0 !important">
            <div class="card" >
                <div class="card-body text-center p-p-2">
                    <h5 class="mb-2 text-center w-100 fw-bold"> Shortage Qty </h5>
                    ...
                    <h3 class="mt-2 p-mb-2"># {{dashInfo.shortageQty}}</h3>
                    <small class="tiles-desc">Items need to import</small>
                </div>
            </div>
        </div>
        <div class="p-sm-12 custom_card_m17 p-lg-2 p-md-2" style="padding-right:0 !important">
            <div class="card" >
                <div class="card-body text-center p-p-2">
                    <h5 class="mb-2 text-center w-100 fw-bold"> Account Holders </h5>
                    <div style="float: center; width: 100%; text-align: center">
                        <img
                    ...
                    <h3 class="mt-2 p-mb-2"># {{dashInfo.accountHolders}}</h3>
        ...
        <div class="p-sm-12 custom_card_m17 p-lg-2 p-md-2" style="padding-right:0 !important">
            <div class="card" >
                <div class="card-body text-center p-p-2">
                    <h5 class="mb-2 text-center w-100 fw-bold"> Monthly Expense </h5>
                    <div style="float: center; width: 100%; text-align: center">
                        <img
        ...
        <div class="p-sm-12 custom_card_m17 p-lg-2 p-md-2" style="padding-right:0 !important">
            <div class="card" >
                <div class="card-body text-center p-p-2">
                    <h5 class="mb-2 text-center w-100 fw-bold"> Items Qty </h5>
                    <div style="float: center; width: 100%; text-align: center">
                        <img
        ...
        <div class="p-sm-12 custom_card_m17 p-lg-2 p-md-2" style="padding-right:0 !important">
            <div class="card" >
                <div class="card-body text-center p-p-2">
                    <h5 class="mb-2 text-center w-100 fw-bold"> Sales Today </h5>
                    <div style="float: center; width: 100%; text-align: center">
                        <img
        ...
        <div class="p-sm-12 custom_card_m17 p-lg-2 p-md-2">
            <div class="card" >
                <div class="card-body text-center p-p-2">
                    <h5 class="mb-2 text-center w-100 fw-bold"> Sales Qty </h5>
                    <div style="float: center; width: 100%; text-align: center">
                        <img
