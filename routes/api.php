...
Route::post('/email/verification-notification', function (Request $request) {
    ...
    return response()->json(['message' => 'Email not found or already verified.'], 400);
...
Route::post('export_user', [UserController::class, 'export'])->middleware(['auth:sanctum','permission:Users']);
...
Route::post('import_bank', [BankController::class, 'import'])->middleware(['auth:sanctum','permission:Banks']);
Route::post('export_bank', [BankController::class, 'export'])->middleware(['auth:sanctum','permission:Banks']);
Route::post('download_csv_bank', [BankController::class, 'downloadCsv'])->middleware(['auth:sanctum','permission:Banks']);
...
Route::post('import_chart_accounts', [ChartAccountController::class, 'import'])->middleware(['auth:sanctum','permission:Chart Of Accounts']);
Route::post('export_chart_accounts', [ChartAccountController::class, 'export'])->middleware(['auth:sanctum','permission:Chart Of Accounts']);
Route::post('download_csv_chart_accounts', [ChartAccountController::class, 'downloadCsv'])->middleware(['auth:sanctum','permission:Chart Of Accounts']);
...
Route::post('import_profilers', [ProfilerController::class,'import'])->middleware(['auth:sanctum','permission:Profilers']);
Route::post('export_profilers', [ProfilerController::class,'export'])->middleware(['auth:sanctum','permission:Profilers']);
Route::post('download_csv_profilers', [ProfilerController::class,'downloadCsv'])->middleware(['auth:sanctum','permission:Profilers']);
...
Route::post('export_bank_transaction',[BankTransactionController::class,'export'])->middleware(['auth:sanctum','permission:Banking']);
...
Route::post('save_purchase_receipt', [PosController::class, 'savePurchaseReceipt'])->middleware(['auth:sanctum','permission:Purchasing']);
