    ...
    <div class="app-container">
      ...
      <div class="p-mt-2">
        ...
        >
          ...
          <Column  header="Free Qty">
            <template #body="slotProps">
              {{ slotProps.data.freeUnit }}x
            </template>
          </Column>
          <Column  header="Sup Bonus">
            <template #body="slotProps">
          ...
          <Column :header="'Purchase Price (' +currency+')'">
             <template #body="slotProps">
              {{ formatAmount(slotProps.data.purchasePrice) }}
            </template>
          </Column>
          <Column header="Purchase Disc">
             <template #body="slotProps">
...
export default class PurchasingReport extends mixins(UtilityOptions) {
  private dt = ref();
  private lists  = [];
  ...
  private items = [
    ...
    { label: "Purchasing Report", to: "purchasing-report"  },
  ];
  ...
  loadList() {
    this.loading = true;
    this.reportService.purchaseReport(this.searchFilters).then((res) => {
